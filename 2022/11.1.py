...
class Monkey:
    def __init__(self, idx, items, operation, divisible, test, true, false):
        self.idx = idx
        self.items = items
...
def read_monkey(decl):
    ...
    return Monkey(monkey_idx, items, operation, divisible, test, true, false)
...
calming_factor = lcm(*[monkey.divisible for monkey in monkeys])
print(calming_factor)
